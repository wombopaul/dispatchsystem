...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function sendResetCodeEmail(Request $request)
    {
        ...
        $user = User::where($request->type, $request->value)->where('user_type', 'manager')->first();
        ...
        return redirect()->route('manager.password.code.verify')->withNotify($notify);
    }
    ...
    public function codeVerify(){
        ...
        if (!$email) {
            ...
            return redirect()->route('manager.password.request')->withNotify($notify);
        }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return redirect()->route('manager.password.reset', $code)->withNotify($notify);
    }
