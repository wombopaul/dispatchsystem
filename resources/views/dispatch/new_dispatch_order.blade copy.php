			            ...
			            <section class="d-none">
			                <div class="inner">
                                ...
                                <div class="form-row">
									<div class="form-holder form-holder-2">
										<label class="form-row-inner">
											<input type="text" class="form-control" id="search_phone_number" name="search_phone_number" required placaholder="Enter a phone number to Proceed">
								...
								<div class="form-row d-none">
									...
									<div class="form-holder">
										<label class="form-row-inner">
											<input type="text" name="your_email_1" id="your_email" class="form-control"  required>
