                            ...
                            @forelse($units as $unit)
                                <tr>
                                    <td data-label="@lang('Name')">
                                        <span class="font-weight-bold">{{__($unit->name)}}</span>
                                    </td>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.unit.store')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn--primary"><i class="fa fa-fw fa-paper-plane"></i>@lang('Create Unit')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.unit.update')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn--primary"><i class="fa fa-fw fa-paper-plane"></i>@lang('Update Unit')</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <a href="javascript:void(0)" class="btn btn-sm btn--primary box--shadow1 text--small addUnit" ><i class="fa fa-fw fa-paper-plane"></i>@lang('Add Unit')</a>
@endpush
