                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    <th>@lang('Sender - Receiver')</th>
                                <th>@lang('Matched Driver')</th>
                            ...
                            @forelse($courierDeliveys as $courierInfo)
                                <tr>
                                    <tr>
                                    <td data-label="@lang('Sender and Receiver')">
                                    <span>{{__($courierInfo->sender_name)}}</span><br>
                                    {{__($courierInfo->receiver_name)}}
                                </td>

                                <td data-label="@lang('Matched Driver')">
                                    <span>
                                        @if($courierInfo->sender_staff_id)
